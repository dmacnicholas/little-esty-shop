...
RSpec.describe "merchant dashboard", type: :feature do
  ...
  it 'lists top 5 customers and number of successful transactions for each customer' do
    ...
    expect(page).to_not have_content("Zack Adams")
  ...
  it 'has a link to view all discounts in the merchant dashboard' do
    ...
    discount_1 = Discount.create!(percent: 20, quantity_threshold: 5, merchant_id: merchant_1.id)
    discount_2 = Discount.create!(percent: 10, quantity_threshold: 3, merchant_id: merchant_1.id)
